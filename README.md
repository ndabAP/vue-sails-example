...
## To do
Password en-/decryption, more tests, more multilingualism, file uploads, upgrading to Sails.js 1.0, mobile version, finalize checkout, use modules for Vuex, uniform code style
